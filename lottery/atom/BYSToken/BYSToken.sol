...
contract BYSToken is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function BYSToken() public {
        symbol = "SGT";
        name = "SnailGame Token";
        decimals = 18;
        totalSupply = 10000000000 * 10 ** 18;  //10bil
        balances[0x00944A8338D501DBE847C08cfcc655f70b22c13E] = totalSupply;
        Transfer(address(0), 0x00944A8338D501DBE847C08cfcc655f70b22c13E, totalSupply);
    }
